...
<body>
    ...
    <main class="content story-content">
        ...
        <article class="story-text">
            ...
            <p>They ran <strong>fast</strong> to the Hall of Fallen Legends. The Monk was sitting on the floor in the center of the statues. He was bleeding, but his face was deeply compassionate. He was meditating <strong>quietly</strong>.</p>
            
            <p>"Monk! We <strong>will take</strong> you to a safe time!" Jack shouted. "We <strong>won't let</strong> them kill you."</p>
            
            <p>The Monk opened his eyes slowly. "You remembered the mission, Jack. That means you are not a normal recruit anymore. You are a true Keeper now. But I <strong>will not stay</strong> in this room. If I stay here, they <strong>will destroy</strong> the timeline."</p>
            ...
            <p>Before they could shoot, The Monk stood up. He raised his hands <strong>calmly</strong>, not to attack, but to protect. The air in the room stopped moving. The soldiers from The Order froze completely. The bullets stopped in the air. Time stopped.</p>
            
            <p>The Monk looked at Jack and Elara. "A Buddhist monk must practice compassion. Leaving you to fight alone is not compassion. I am tired of watching from the center of time. I <strong>will not be</strong> just a guide anymore."</p>
            
            <p>"What <strong>will you do</strong>?" Jack asked.</p>
            
            <p>"I <strong>will join</strong> you," The Monk smiled peacefully. He closed his hands, and eight of the frozen soldiers disappeared into a portal. But two soldiers suddenly unfroze and attacked him.</p>
            
            <p>The Monk didn't lose his smile. Moving with perfect calmness, he used beautiful martial arts. In two fluid movements, he neutralized both soldiers. They fell to the floor, asleep.</p>
            
            <p>The Monk fixed his clothes slowly. "It is a dirty job," he said without altering his voice, "but someone has to do it. I will travel with you. The three of us <strong>will protect</strong> the universe together."</p>
            
            <p>Jack looked at the empty room. He looked at Elara, and he looked at The Monk. His old life was boring and grey. This was where he belonged.</p>
            
            <p>"I <strong>won't go</strong> back to the city," Jack said <strong>firmly</strong>. "I <strong>will stay</strong> with you."</p>
            
            <p>Captain Elara touched Jack's shoulder and smiled at The Monk. "Welcome to the team. Tomorrow, we <strong>will have</strong> a lot of work."</p>
        </article>
        ...
        <section class="quiz">
            ...
            <div class="quiz-question">
                <p>4. What did The Monk decide to do at the end?</p>
                <button class="quiz-btn" onclick="checkAnswer(this, false)">He decided to become a statue</button>
                <button class="quiz-btn" onclick="checkAnswer(this, true)">He decided to join Jack and Elara to protect the universe together</button>
                <button class="quiz-btn" onclick="checkAnswer(this, false)">He decided to return to his monastery</button>
            </div>
        </section>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const storyVocabulary = [
                ...
                { id: '6', en: 'compassion', es: 'compasión' },
                { id: '7', en: 'if', es: 'si (condicional)' },
                { id: '8', en: 'together', es: 'juntos' }
            ];
