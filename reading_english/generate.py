...
<body>
    ...
    <main class="content story-content">
        <div class="instruction-notice">
            <strong>Before you read:</strong> Match the words on the left with their translations on the right. 
            When you finish, the story will appear!
        </div>

        <section id="pre-reading" class="vocabulary">
            <h2>1. Match the Words</h2>
            <div class="matching-game-container">
                <div class="match-column" id="english-words"></div>
                <div class="match-column" id="spanish-words"></div>
            </div>
        </section>

        <section id="story-section" class="story-text" style="display: none;">
        ...
        <section id="quiz-section" class="quiz" style="display: none;">
            <h2>2. Reading Comprehension</h2>
            <div id="quiz-container">
                <!-- Quiz questions will be injected here via JS -->
            </div>
        </section>

        <section id="recall-section" class="vocabulary" style="display: none;">
            <h2>3. Vocabulary Recall</h2>
            <p style="margin-bottom: 1.5rem; color: #cbd5e1;">Type the English word for each Spanish translation. If you don't remember, use the Hint button.</p>
            <div id="recall-container" class="recall-list">
                <!-- Recall inputs will be injected here via JS -->
            </div>
        </section>
    ...
    <script>
        // Initialize the story logic with specific vocabulary and quiz data
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const quizData = [
                {
                    question: "Where was Jack when he met The Monk?",
                    options: [
                        "In a sunny park",
                        "In a dark bar",
                        "In a police station"
                ...
                {
                    question: "Who are 'The Order'?",
                    options: [
                        "A group that wants to control the past and the future",
                        "The people who built the statues",
                        "A group of anarchists"
                    ],
                    correctIndex: 0
                },
                {
                    question: "Why must the man board the Titanic?",
                    options: [
                        "Because he is a bad person",
                        "Because if he lives, his grandson will destroy freedom",
                        "Because he wants to travel to America"
                    ],
                    correctIndex: 1
                },
                {
                    question: "What happens to the recruits after the mission?",
                    options: [
                        "They become statues",
                        "They forget everything and return to their lives",
                        "They stay in the Chronos Agency"
                    ],
                    correctIndex: 1
                }
            ];

            initStory(vocabulary, quizData);
        });
    </script>
</body>
</html>"""
...
print("Created the_chronos_protocol_part1.html")
